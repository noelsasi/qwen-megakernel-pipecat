...
2. Run end-to-end voice pipeline: `V2_MEGAKERNEL=1 TTS_BACKEND=v2 uvicorn server.pipeline.voice_agent:app --host 0.0.0.0 --port 8080`
...
megakernel _inside_ the working v2 decode loop at the talker backbone step.
...
3. Phase 3 (now planned): put megakernel _inside_ the Phase 2 loop, replacing TalkerGraph.
